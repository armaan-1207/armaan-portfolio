      ...
      <Section id="about" index="01" title="about.md">
        <div className="grid gap-12 md:grid-cols-5 items-start">
          ...
          <div className="md:col-span-3 space-y-5">
            {/* Terminal bio */}
            <div className="about-item overflow-hidden rounded-lg border border-border bg-card/60 shadow-[0_0_20px_rgba(0,0,0,0.5)]">
              {/* Top bar */}
            ...
            {/* Education card */}
            <div className="about-item rounded-lg border border-secondary/25 bg-card/60 p-5 transition-all hover:border-secondary/50 hover:shadow-[0_0_24px_rgba(0,217,255,0.07)]">
            ...
            {/* Focus tags */}
            <div className="about-item flex flex-wrap gap-2">
              {[
                "Web AppSec",
                "Network Forensics",
                "Linux Security",
          ...
          <div ref={hexRef} className="md:col-span-2 flex justify-center items-center pt-4 opacity-0">
